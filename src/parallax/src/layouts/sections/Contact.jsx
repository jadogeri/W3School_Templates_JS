        ...
        <form action="/action_page.php" target="_blank">
          ...
          >
            <div className="w3-half">
              <InputField
                className="w3-input w3-border" type="text" placeholder="Name" required="" name="Name"
              />
            </div>
            <div className="w3-half">
              <InputField
                className="w3-input w3-border" type="text" placeholder="Email" required="" name="Email"
              />
            </div>
          </div>
          <InputField
            className="w3-input w3-border" type="text" placeholder="Message" required="" name="Message"
          />
          <button
